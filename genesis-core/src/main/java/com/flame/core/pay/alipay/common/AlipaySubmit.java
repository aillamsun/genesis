package com.flame.core.pay.alipay.common;

import com.flame.core.pay.alipay.AlipayConfig;
...
public class AlipaySubmit {
    ...
    public static String buildRequestMysign(Map<String, String> sPara) {
        ...
        String mysign = "";
        if (AlipayConfig.web_sign_type.equals("MD5")) {
            mysign = MD5.sign(prestr, AlipayConfig.web_apy_key, AlipayConfig.input_charset);
        } else if (AlipayConfig.web_sign_type.equals("RSA")) {
    ...
    private static Map<String, String> buildRequestPara(Map<String, String> sParaTemp) {
        ...
        sPara.put("sign_type", AlipayConfig.web_sign_type);
